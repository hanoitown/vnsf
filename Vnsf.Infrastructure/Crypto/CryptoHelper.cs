...
namespace Vnsf.Infrastructure.Crypto
{
    public static class CryptoHelper
    {
        ...
        {
            var count = 0; // SecuritySettings.Instance.PasswordHashingIterationCount;
            if (count <= 0)
            {
        ...
        public static int GetIterationsFromYear(int year)
        {
            if (year > StartYear)
            {
