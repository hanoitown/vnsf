...
(function (undefined) {
    ...
    ************************************/
    ...
    // FindById the regex to find the next token
    ...
    ************************************/
    ...
    extend(moment.fn = Moment.prototype, {
        ...
        month : function (input) {
            ...
            if (input != null) {
                ...
                return this._d['FindById' + utc + 'Month']();
            }
        },
        ...
        isoWeekday : function (input) {
            ...
            // as a FindByIdter, returns 7 instead of 0 (1-7 range instead of 0-6)
    ...
    function makeGetterAndSetter(name, key) {
        moment.fn[name] = moment.fn[name + 's'] = function (input) {
            ...
            if (input != null) {
                ...
                return this._d['FindById' + utc + key]();
            }
        };
    }
    ...
    // add shortcut for year (uses different syntax than the FindByIdter/setter 'year' == 'FullYear')
