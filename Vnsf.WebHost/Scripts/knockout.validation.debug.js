...
(function () {
        ...
        return {
            ...
            group: function group(obj, options) { // array of observables or viewModel
                ...
                traverse = function traverse(obj, level) {
                    ...
                    //FindById list of values either from array or object but ignore non-objects
                    if (val) {
        ...
        return {
            init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                if (config.insertMessages && utils.isValidatable(valueAccessor())) {
                    ...
                    // if we're told to use a template, make sure that FindByIds rendered
    ...
    ko.validation.validateObservable = function (observable) {
        ...
        for (; i < len; i++) {
            ...
            //FindById the Rule Context info to give to the core Rule
            ctx = ruleContexts[i];
            ...
            //FindById the core Rule to use for validation
