...
namespace Vnsf.Data.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// <summary>
        /// FindById and set the <see cref="DbContext"/> with which to initialize a repository
        /// if one must be created.
        /// </summary>
        public DbContext DbContext { get; set; }

        /// <summary>
        /// FindById or create-and-cache the default <see cref="IRepository{T}"/> for an entity of type T.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// <summary>
        /// FindById or create-and-cache a repository of type T.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// <summary>
        /// FindById the dictionary of repository objects, keyed by repository type.
        /// </summary>
        /// <remarks>
